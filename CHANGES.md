...
* Due to a bug in the method for exporting match files in partitura, symbolic time in the match files was incorrectly represented in quarters instead of beats. This bug affected the `Mozart_K331_1st-mov` and `Chopin_op38` files which have a time signature of 6/8. This issue was addressed with [PR #454](https://github.com/CPJKU/partitura/pull/454) in partitura.
